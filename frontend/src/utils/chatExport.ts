...
export class ChatExportService {
  ...
  static generateHTML(data: ChatExportData): string {
    const { session, messages, conversationTopic, businessContext, personaInfoMap, exportedAt } = data;
...
<body>
    <div class="container">
        ...
        <!-- Footer -->
        <footer class="footer">
            <p>Generated by Group Chat AI - Practice your presentations with AI-powered personas</p>
